...
During my second year my team and I developed a custom game engine called **Kitty Engine** for our group projects. It has so far been used for 3 successful game projects. This page goes more in depth on some of my contributions on the engine.
...
**[Disclaimer]** The source code was moved from a private perforce server to github and all previous commit history has thus been deleted. On the other hand there is a game project in the repo. The game can be played here: https://kapten-h.itch.io/igbtcwf

## GameObject Component System

When we first started building the engine, I took on the responsibility of writing the code that handles the logic side of the game. This includes handling scenes, updating objects and running game specific code in a structured way. After some researching and discussions in the team I took the decision to build a GameObject/Component system that is familiar to Unitys scripting interface. I chose to design it this way to make it quick and easy for us programmers to start working on gameplay as we all had experience with Unitys system.
